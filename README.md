...
**Respuesta**
En nuestra implementación ya intentamos una “parada temprana”: agregamos un contador global compartido y hacemos que cada hilo deje de buscar cuando el total llega a `BLACK_LIST_ALARM_COUNT`.

Lo nuevo del problema es que ahora los hilos comparten estado, así que necesitamos coordinación/sincronización para que el contador sea correcto y todos vean el valor actualizado a tiempo.
